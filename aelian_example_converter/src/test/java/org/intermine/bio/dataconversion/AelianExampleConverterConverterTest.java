...
public class AelianExampleConverterConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    AelianExampleConverterConverter converter;
    MockItemWriter itemWriter;

    public AelianExampleConverterConverterTest(String arg) {
        super(arg);
    }
